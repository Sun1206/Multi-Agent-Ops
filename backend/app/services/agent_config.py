...
from app.agent_registry import CATALOG
from app.core.exceptions import BusinessError
from app.models import AIOpsAgentConfig, AIOpsMCPServer, AIOpsModelProvider, AIOpsSkill, Role, User
from app.selectors.agent_config import RESOURCE_MODELS, get_resource, provider_hint
from app.services.config_secrets import encrypt_secret, transform_auth
...
async def clone_skill(session: AsyncSession, identifier: int, values: dict):
    from app.schemas.agent_config import SkillPatch
